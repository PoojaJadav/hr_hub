<div>
    <div class="bg-gray-100 text-gray-900 leading-normal 2xl:flex 2xl:justify-center 2xl:w-full 2xl:p-4">
        <div class="py-8 pt-4 2xl:p-8 bg-white">
            <div class="overflow-x-auto mt-4">
                <div class="table-responsive">
                    <div class="mb-4 mt-4 ml-2">
                        <input wire:model="startDate" max="{{ $endDate }}" class="border-gray-300 text-base border-solid rounded-lg" type="date">
                        <input wire:model="endDate" min="{{ $startDate }}" class="border-gray-300 text-base border-solid rounded-lg" type="date">
                    </div>
