                                ...
                                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                    <table class="min-w-full divide-y-2 divide-gray-500">
                                        <thead>
                                            ...
                                            <th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900">Total Present</th>
                                            <th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900">Total Leave</th>
                                            <th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900">Total WFH</th>
                                            <th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900">Total Half-Day</th>
                                            <th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900">Total Late</th>
                                            </tr>
                                        </thead>
                                        <tbody class="divide-y divide-gray-200">
                                            @foreach ($employees as $employee)
                                                    <tr>
                                                        ...
                                                        <td class="whitespace-nowrap py-4 px-3 text-sm text-gray-500"><span>Working Days Count</span></td>
